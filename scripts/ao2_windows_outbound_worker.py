...
AO2_FULL_WINDOWS_PROFILE: tuple[ProfileCommand, ...] = (
    ...
    *ao2_cli_approval_profile_commands(
    ...
    {
        "name": "test-cli-approval-factory-queue",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    {
        "name": "test-cli-approval-factory-project",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    {
        "name": "test-cli-approval-factory-pack",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    {
        "name": "test-cli-approval-factory-run",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    {
        "name": "test-cli-approval-factory-evaluator-closer",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    {
        "name": "test-cli-plugin-consumer-lifecycle",
        "argv": (
            "cargo",
            "test",
            "-p",
            ...
            "{ao2-full-target-dir}",
            "--test",
            "cli_plugin_consumer_lifecycle",
        ),
    },
    {
        "name": "test-cli-plugin-release-candidate",
        "argv": (
            "cargo",
            "test",
            "-p",
            ...
            "{ao2-full-target-dir}",
            "--test",
            "cli_plugin_release_candidate",
        ),
    },
    {
        "name": "test-cli-plugin-distribution",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    {
        "name": "test-cli-plugin-wrapper-harness",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    *ao2_cli_approval_profile_commands(
    ...
    {
        "name": "test-cli-workbench-operator",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    {
        "name": "test-cli-workbench-launch",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    {
        "name": "test-cli-workbench-greenfield",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    {
        "name": "test-cli-workbench-evidence",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    {
        "name": "test-cli-workbench-export",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    {
        "name": "test-cli-workbench-factory",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    {
        "name": "test-cli-workbench-project-start",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    {
        "name": "test-cli-workbench-project-start-recovery",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    {
        "name": "test-cli-workbench-project-start-claim",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    {
        "name": "test-cli-workbench-project-start-post-continuation",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    {
        "name": "test-cli-workbench-project-start-release",
        "argv": (
            "cargo",
            "test",
            "-p",
    ...
    {
        "name": "test-cli-workbench-run-evidence",
        "argv": (
            "cargo",
            "test",
            "-p",
