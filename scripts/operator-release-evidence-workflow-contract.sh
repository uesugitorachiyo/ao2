...
require_text "$WORKFLOW" "assert len(summary[\"checks\"]) == 12"
require_text "$WORKFLOW" "public-release-consumer-smoke-"
require_text "$WORKFLOW" "ao2.public-release-consumer-smoke.v1"
require_text "$WORKFLOW" "downloads_public_release_archives"
require_text "$WORKFLOW" "ao2-public-release-pair-digest-audit"
require_text "$WORKFLOW" "ao2.public-release-pair-digest-audit.v1"
require_text "$WORKFLOW" "archive_parity_status"
...
require_text "$VERIFICATION_DOC" "public-release-consumer-smoke-linux"
require_text "$VERIFICATION_DOC" "ao2.public-release-consumer-smoke.v1"
...
require_text "$PUBLIC_RELEASE_DOC" "public-release-consumer-smoke-linux"
require_text "$PUBLIC_RELEASE_DOC" "ao2.public-release-consumer-smoke.v1"
