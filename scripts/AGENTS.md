...
- Require an exact, fresh, digest-bound exclusive-host lease before a physical qualification action. A lease must deny active interactive work, overlapping leases, broad process termination, graphical-session mutation, and cleanup outside its unique scratch root; lease readiness is not release or mutation authority.
