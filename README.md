...
[![Latest release](https://img.shields.io/github/v/release/uesugitorachiyo/ao2?label=latest%20stable%20release)](https://github.com/uesugitorachiyo/ao2/releases/tag/v0.5.5)
...
This public export is prepared from AO2 `0.5.5`. It is intentionally
local-first:
...
[`v0.5.5`](https://github.com/uesugitorachiyo/ao2/releases/tag/v0.5.5).
...
gh release download v0.5.5 --repo uesugitorachiyo/ao2 \
  --pattern ao2-0.5.5-macos-aarch64.tar.gz \
  --pattern SHA256SUMS \
  --dir dist-release
(cd dist-release && grep 'ao2-0.5.5-macos-aarch64.tar.gz' SHA256SUMS | shasum -a 256 -c -)
```

Use the same release base URL for Linux and Windows archives:

```text
https://github.com/uesugitorachiyo/ao2/releases/download/v0.5.5/ao2-0.5.5-linux-x86_64.tar.gz
https://github.com/uesugitorachiyo/ao2/releases/download/v0.5.5/ao2-0.5.5-windows-x86_64.tar.gz
```
...
For Rust/Cargo work with the published `v0.5.5` binary, run the Cargo workflow
file by path from an AO2 checkout at the `v0.5.5` tag or newer:
...
powershell -ExecutionPolicy Bypass -File .\scripts\smoke-windows-release.ps1 `
  -Archive .\dist-windows\ao2-0.5.5-windows-x86_64.tar.gz
```
...
- [AO2 v0.5.5 stable release notes](docs/release/v0.5.5-stable.md)
