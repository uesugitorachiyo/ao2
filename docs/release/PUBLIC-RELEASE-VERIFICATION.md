...
`promotion_confirm=promote-stable-v0.5.1-v0.1.16`; any other non-empty value
...
`promotion_confirm=promote-stable-v0.5.1-v0.1.16` value.
...
the exact `promotion_confirm=promote-stable-v0.5.1-v0.1.16` value for the
