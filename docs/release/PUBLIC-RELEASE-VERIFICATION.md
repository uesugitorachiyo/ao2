...
manually and runs on schedule. It downloads AO2 `v0.5.9` release archives,
...
manually and runs on schedule. It downloads all public `v0.1.19` release
...
`promotion_confirm=promote-stable-v0.5.2-v0.1.17`; any other non-empty value
...
`promotion_confirm=promote-stable-v0.5.2-v0.1.17` value.
...
the exact `promotion_confirm=promote-stable-v0.5.2-v0.1.17` value for the
