...
manually and runs on schedule. It downloads AO2 `v0.5.1` release archives,
...
`promotion_confirm=promote-stable-v0.5.1-v0.1.15`; any other non-empty value
...
`promotion_confirm=promote-stable-v0.5.1-v0.1.15` value.
...
the exact `promotion_confirm=promote-stable-v0.5.1-v0.1.15` value for the
