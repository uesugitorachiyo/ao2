...
This guide starts from the public AO2 `v0.5.10` release and ends with a local
...
On Windows PowerShell, extract `ao2-0.5.10-windows-x86_64.tar.gz`, then run:
...
The installed version should report `0.5.10`. `ao2 doctor --json` should include
