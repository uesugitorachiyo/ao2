...
AO2 `v0.5.12` publishes aggregate checksums and GitHub attestations, but not the
detached RSA provenance files required by the `v0.5.12` `install update`
...
```sh
ao2 install update \
  --archive ao2-0.5.12-<platform>.tar.gz \
...
[`v0.5.12` release](https://github.com/uesugitorachiyo/ao2/releases/tag/v0.5.12)
...
The current stable public release line is `v0.5.12`.
