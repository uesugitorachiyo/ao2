...
- `npm run release:public-pair-digest-audit`: read-only post-release verifier
  ...
  `ao2-0.5.9-linux-x86_64.tar.gz`, `ao2-0.5.9-macos-aarch64.tar.gz`, and
  `ao2-0.5.9-windows-x86_64.tar.gz`, plus control-plane
  `ao2-control-plane-0.1.19-linux-x86_64.tar.gz`,
  `ao2-control-plane-0.1.19-macos-aarch64.tar.gz`, and
  `ao2-control-plane-0.1.19-windows-x86_64.tar.gz`, and compares every closure
...
- the `v0.5.12` candidate Windows archive checksum-covers
  ...
  credential use. Linux and macOS candidate archives omit both Windows files.
